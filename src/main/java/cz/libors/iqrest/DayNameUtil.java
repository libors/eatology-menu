...
public class DayNameUtil {
    ...
    private static Pattern pdfDatePattern = Pattern.compile("^\\s*([0-9]*)\\.\\s*([0-9]*)\\.\\s*$");
    ...
    public static LocalDate getFromMenuName(String menuName) {
    ...
    public static String getNameFromParsedPdf(String origPdfName) {
        ...
        return matcher.group(1) + "." + matcher.group(2) + "." + date.getYear();
    }
